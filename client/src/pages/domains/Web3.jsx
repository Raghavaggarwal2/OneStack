...
const Web3 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-amber-100/50 to-amber-200 dark:from-amber-900/40 dark:via-amber-800/40 dark:to-amber-700/40 py-8">
          ...
          <div className="text-center pt-12">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master blockchain technology and decentralized application development
              </p>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="ml-4">
                      <input
                        ...
                        className="w-5 h-5 text-amber-600 rounded border-gray-300 focus:ring-amber-500 dark:focus:ring-amber-600 dark:ring-offset-gray-800 dark:bg-gray-900 dark:border-gray-600"
                      />
                    </div>
                  </div>
                ))}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/80 dark:bg-black/40 backdrop-blur-sm rounded-2xl shadow-lg p-6">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">Web3.js</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">Ethers.js</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">Hardhat</span>
              </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-black/40 backdrop-blur-sm rounded-2xl shadow-lg p-6">
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-gray-900 dark:text-white">Solidity Docs</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Official Solidity Documentation</div>
                  </div>
                </a>
              </div>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                      <div className="text-white text-sm font-medium">Complete Web3 Development Course</div>
                    </div>
                  </a>
                </div>
              </div>
