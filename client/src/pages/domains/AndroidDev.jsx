          ...
          <div className="text-center pt-12">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master Android app development with Kotlin and modern architecture
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">Kotlin</span>
                ...
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200">XML</span>
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-lime-100 dark:bg-lime-900 text-lime-800 dark:text-lime-200">Android SDK</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-gray-900 dark:text-white">Android Developers</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Official Android Documentation</div>
                  </div>
                </a>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <img 
                      src="https://img.youtube.com/vi/fis26HvvDII/maxresdefault.jpg"
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                      <div className="text-white text-sm font-medium">Complete Android Development Course</div>
                    </div>
                  </a>
                </div>
              </div>
