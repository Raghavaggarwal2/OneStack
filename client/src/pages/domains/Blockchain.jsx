...
const domainColor = "bg-amber-500"; // From domainColors in domainList.js
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">Hyperledger</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">Web3.js</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">Truffle</span>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            Blockchain is a decentralized ledger technology that ensures transparency and security in transactions. It's the backbone of cryptocurrencies and has applications in various industries. By using cryptographic techniques and distributed consensus, blockchain provides a tamper-proof record of transactions that can be verified by all participants in the network.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div className="mb-4">
          ...
          >
            ...
            Ethereum Docs - Blockchain Development Platform
          </a>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              Blockchain Tutorial - Complete Blockchain Course for Beginners
            </a>
            <a 
