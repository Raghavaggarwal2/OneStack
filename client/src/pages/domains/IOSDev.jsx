      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {/* Tech stack tags */}
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">Swift</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">Objective-C</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">Xcode</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">UIKit</span>
            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-sm">SwiftUI</span>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            iOS Development is the process of creating applications for Apple's iOS devices. It requires understanding of Apple's development tools and guidelines. With Swift as the primary programming language, iOS developers build apps for iPhones, iPads, Apple Watch, and other Apple devices, focusing on performance, user experience, and integration with Apple's ecosystem.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              iOS Development Tutorial - Swift Programming for Beginners
            </a>
            <a 
              href="https://www.youtube.com/watch?v=yuo50-TiKgo" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 flex items-center"
            >
              ...
              SwiftUI Masterclass - Build Complete iOS Applications
            </a>
          </div>
        </div>
      </div>
