    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-8">
          <Link 
            to="/domains" 
            className="absolute top-0 left-0 flex items-center space-x-2 text-gray-600 dark:text-gray-300 hover:text-rose-600 dark:hover:text-rose-400 transition-colors"
          >
          ...
          <div className="text-center pt-12">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Master ethical hacking and cybersecurity techniques
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-3xl font-bold text-rose-600 dark:text-rose-400">{progress}%</span>
              </div>
              <ProgressBar 
                value={progress} 
                color={domainColor} 
                  ...
                  >
                    ...
                    <div className="ml-4">
                      <input
                        ...
                        className="w-5 h-5 text-rose-600 rounded border-gray-300 focus:ring-rose-500 dark:focus:ring-rose-600 dark:ring-offset-gray-800 dark:bg-gray-900 dark:border-gray-600"
                      />
                    </div>
                  </div>
                ))}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <span className="px-4 py-2 rounded-full text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">Burp Suite</span>
            ...
            <div className="bg-white dark:bg-black rounded-2xl shadow-lg p-6 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-40">
              ...
              <div className="mb-8">
                ...
                <a 
                  href="https://www.hackthebox.com/universities" 
                  target="_blank" 
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-rose-600 dark:text-rose-400 mr-4" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                  </svg>
                  <div>
                    <div className="font-medium text-gray-900 dark:text-white">Hack The Box Academy</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Hands-on Cybersecurity Training</div>
                  </div>
                </a>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <img 
                      src={`https://img.youtube.com/vi/3Kq1MIfTWCE/maxresdefault.jpg`}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                      <div className="text-white text-sm font-medium">HackerSploit - Ethical Hacking Course</div>
                    </div>
                  </a>

                  <a 
                    href="https://www.youtube.com/watch?v=dz7Ntp7KQGA" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden rounded-lg aspect-video"
                  >
                    <img 
                      src={`https://img.youtube.com/vi/dz7Ntp7KQGA/maxresdefault.jpg`}
                      alt="Complete Ethical Hacking Bootcamp"
                      className="w-full h-full object-cover transition-transform group-hover:scale-105"
                    />
                    <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <svg className="w-12 h-12 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                      <div className="text-white text-sm font-medium">Cybersecurity Career Guide - Complete Bootcamp</div>
                    </div>
                  </a>
                </div>
              </div>
